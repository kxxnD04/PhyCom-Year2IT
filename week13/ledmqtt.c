...
const char WIFI_SSID[] = "Karn";          // CHANGE TO YOUR WIFI SSID
const char WIFI_PASSWORD[] = "ddd44322";  // CHANGE TO YOUR WIFI PASSWORD

const char MQTT_BROKER_ADRRESS[] = "mqtt-dashboard.com";  // CHANGE TO MQTT BROKER'S ADDRESS
const int MQTT_PORT = 1883;
const char MQTT_CLIENT_ID[] = "clientId-8NylWbtpmo";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "phycom/66070014";   // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "phycom/66070014";  // CHANGE IT AS YOU DESIRE

const int PUBLISH_INTERVAL = 1;  // 60 seconds
...
//     // Publish the message to the MQTT topic
//     mqtt.publish(PUBLISH_TOPIC, messageBuffer);0
